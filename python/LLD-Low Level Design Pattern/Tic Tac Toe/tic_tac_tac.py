...
class TicTacToeBoard(tk.Tk):
    ...
    def _create_board_grid(self):
        ...
        self.rowconfigure(tuple(range(self._game.board_size)), weight=1, minsize=50)
        self.columnconfigure(tuple(range(self._game.board_size)), weight=1, minsize=75)
        grid_frame.pack()
        for row in range(self._game.board_size):
            for col in range(self._game.board_size):
                button = tk.Button(master=grid_frame, text="", font=font.Font(size=36, weight="bold"), fg="black", width=5, height=2, highlightbackground="lightblue")
